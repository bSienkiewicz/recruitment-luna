...
const Navbar = () => {
  ...
  return (
    <div className="h-16 shadow-2xl shadow-black/5">
      <div className="container mx-auto flex items-center justify-between h-full px-5 select-none">
        <Link to={'/'} className="relative cursor-pointer select-none h-full flex items-center">
